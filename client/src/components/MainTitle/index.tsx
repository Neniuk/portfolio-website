...
const MainTitle = () => (
    <div className="mb-0 mt-6 flex w-[95%] flex-row items-center justify-center gap-8 overflow-hidden md:mb-6 md:w-full">
        <img
            className="main-title-decoration h-[32px] w-auto max-w-full flex-shrink-0 object-contain brightness-50 md:w-[320px]"
        ...
        <img
            className="main-title-decoration h-[32px] w-auto max-w-full flex-shrink-0 rotate-180 object-contain brightness-50 md:w-[320px]"
            src={mainTitleDecorationBlue}
            alt="Main title decoration"
        />
    </div>
